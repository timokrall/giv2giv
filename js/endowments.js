...
function DetailedCard(sub, isFeatured) {
	...
	var html = '';
/*
	html += '<figure class="span3 picture-item" data-groups=\'["wildlife"]\'>'+
		'<img src="'+GLOBAL.SERVER_URL+'/logos/'+this.slug+'.png" height="145" width="230" />'+
    '<div class="picture-item__details">'+
      '<figcaption class="picture-item__title">'+this.cardTitle+'</figcaption>'+
      '<p class="picture-item__tags">tag1, tag2</p>'+
    '</div>'+
  '</figure>';
*/
